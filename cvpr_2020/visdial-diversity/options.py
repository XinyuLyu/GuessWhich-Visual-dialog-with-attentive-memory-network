...
def readCommandLine(argv=None):
    ...
    #-------------------------------------------------------------------------
    # Data input settings
    parser.add_argument('-inputImg', default='/home/lvxinyu/code/visdial-diversity/data/visdial/data_img.h5',
                            help='HDF5 file with image features')
    parser.add_argument('-inputQues', default='/home/lvxinyu/code/visdial-diversity/data/visdial/chat_processed_data.h5',
                            help='HDF5 file with preprocessed questions')
    parser.add_argument('-inputJson', default='/home/lvxinyu/code/visdial-diversity/data/visdial/chat_processed_params.json',
                            help='JSON file with info and vocab')
    parser.add_argument('-inputDenseJson', default='/home/lvxinyu/code/visdial-diversity/data/visdial/visdial_1.0_val_dense_annotations.json',
