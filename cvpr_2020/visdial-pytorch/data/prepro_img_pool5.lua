...
cmd:option('-cnnProto', '/hhd/lvxinyu/data/data/models//vgg16/VGG_ILSVRC_16_layers_deploy.prototxt', 'Path to the CNN prototxt')
cmd:option('-cnnModel', '/hhd/lvxinyu/data/data/models/vgg16/VGG_ILSVRC_16_layers.caffemodel', 'Path to the CNN model')
