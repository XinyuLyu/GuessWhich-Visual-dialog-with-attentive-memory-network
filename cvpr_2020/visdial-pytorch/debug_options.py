...
def readCommandLine(argv=None):
    ...
    '''parser.add_argument('-startFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/HCIAE/abot_ep_13.vd',
                            help='Copy weights from model at this path')'''
    parser.add_argument('-qstartFrom', type=str, default='',
                            help='Copy weights from qbot model at this path')
    '''parser.add_argument('-qstartFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/sl_q/qbot_ep_64.vd',
                            help='Copy weights from qbot model at this path')'''
    ...
    parser.add_argument('-useHuberLoss',action='store_true',
