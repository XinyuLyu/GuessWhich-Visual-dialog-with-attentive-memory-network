...
def readCommandLine(argv=None):
    ...
    parser.add_argument('-startFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/sl_a/abot_60.vd',
                        help='Copy weights from model at this path')
    parser.add_argument('-qstartFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/cosine_loss/qbot_ep_13.vd',
