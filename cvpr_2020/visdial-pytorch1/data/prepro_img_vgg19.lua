...
cmd:text()
cmd:text('Options')
cmd:option('-inputJson', '/home/lvxinyu/visdial/chat_processed_params.json', 'Path to JSON file')
cmd:option('-imageRoot', '/path/to/images/', 'Path to COCO image root')
cmd:option('-cnnProto', '/home/lvxinyu/data/models/vgg19/VGG_ILSVRC_19_layers_deploy.prototxt', 'Path to the CNN prototxt')
cmd:option('-cnnModel', '/home/lvxinyu/data/models/vgg19/VGG_ILSVRC_19_layers.caffemodel', 'Path to the CNN model')
cmd:option('-trainSplit', 'train', 'Which split to use: train | trainval')
cmd:option('-batchSize', 50, 'Batch size')

cmd:option('-outName', '/home/lvxinyu/visdial/data_img.h5', 'Output name')
