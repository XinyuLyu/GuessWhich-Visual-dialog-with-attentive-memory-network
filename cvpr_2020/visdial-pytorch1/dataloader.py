...
class VisDialDataset(Dataset):
    def __init__(self, params, subsets):
        ...
        print('\nDataloader loading json file: /hhd/lvxinyu/aqm_plus/resources/data/visdial'
              '/chat_processed_params.json')
        # with open(self.inputJson, 'r') as fileId:
        with open('/hhd/lvxinyu/aqm_plus/resources/data/visdial/chat_processed_params.json',
        ...
        quesFile = h5py.File('/hhd/lvxinyu/aqm_plus/resources/data/visdial/chat_processed_data.h5', 'r')

        if self.useIm:  # if "string"= if True
            # Read images
            # print('Dataloader loading h5 file: ' + self.inputImg)
            imgFile = h5py.File('/hhd/lvxinyu/aqm_plus/resources/data/visdial/data_img.h5', 'r')
