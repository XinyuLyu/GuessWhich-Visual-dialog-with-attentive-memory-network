...
def readCommandLine(argv=None):
    ...
    #-------------------------------------------------------------------------
    # Data input settings
    parser.add_argument('-inputImg', default='/hhd/lvxinyu/aqm_plus/resources/data/visdial/data_img.h5',
                            help='HDF5 file with image features')
    parser.add_argument('-inputQues', default='/hhd/lvxinyu/aqm_plus/resources/data/visdial/chat_processed_data.h5',
                            help='HDF5 file with preprocessed questions')
    parser.add_argument('-inputJson', default='/hhd/lvxinyu/aqm_plus/resources/data/visdial/chat_processed_params.json',
    ...
    parser.add_argument('-verbose', type=int, default=1,
                            ...
                            choices=[1, 2])
    parser.add_argument('-savePath', default='/hhd/lvxinyu/visdial-pytorch/checkpoints/',
                            help='Path to save checkpoints')
    parser.add_argument('-saveName', default='',
                            help='Name of save directory within savePath')
    parser.add_argument('-startFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/Community_v0.9/abot/abot_ep_99.vd',
                        help='Copy weights from model at this path')

    parser.add_argument('-qstartFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/MN5/01-Nov-19-01:57:38-Fri_6859190/qbot_ep_14.vd',
    ...
    parser.add_argument('-numEpochs', default=15, type=int, help='Epochs')
    ...
    parser.add_argument('-CELossCoeff', default=1, type=float,
                            help='Coefficient for cross entropy loss')
    parser.add_argument('-featLossCoeff', default=10000, type=float,
    ...
    parser.add_argument('-useCosSimilarityLoss', action='store_true',
    ...
    parser.add_argument('-useHuberLoss',action='store_false',
    ...
    parser.add_argument('-useGPU', action='store_false', help='Use GPU or CPU')
    ...
    parser.add_argument('-evalModeList', default=['ABotRank'], nargs='+',
