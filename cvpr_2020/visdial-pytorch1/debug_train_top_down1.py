...
for epochId, idx, batch in batch_iter(dataloader):  # 65, 2536, 20 batches of data, each iter different batch
    ...
    image = Variable(batch['img_feat_vgg'], requires_grad=False)  # (20,4096)
    image_36 = Variable(batch['img_feat_36'], requires_grad=False)  # (20,4096)
