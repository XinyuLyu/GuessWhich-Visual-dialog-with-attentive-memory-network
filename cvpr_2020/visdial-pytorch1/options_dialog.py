...
def readCommandLine(argv=None):
    ...
    parser.add_argument('-cocoDir', default='/hhd/lvxinyu/data/data/coco_image/',
                        help='Directory for coco images, optional')
    parser.add_argument('-cocoInfo', default='', #/hhd/lvxinyu/aqm_plus/resources/data/visdial_0.9/chat_processed_params.json
    ...
    parser.add_argument('-verbose', type=int, default=1,
                        ...
                        choices=[1, 2])
    parser.add_argument('-savePath', default='/hhd/lvxinyu/aqm_plus/checkpoints/',
                        help='Path to save checkpoints')
    parser.add_argument('-saveName', default='',
                        help='Name of save directory within savePath')
    parser.add_argument('-startFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/diverse/RL-Diverse-QBot-Abot/1/10-Nov-19-17:11:19-Sun_6014524/abot_ep_14.vd',
                        help='Copy weights from model at this path')
    parser.add_argument('-qstartFrom', type=str, default='/hhd/lvxinyu/visdial-pytorch/checkpoints/diverse/RL-Diverse-QBot-Abot/1/10-Nov-19-17:11:19-Sun_6014524/qbot_ep_14.vd',
    ...
    parser.add_argument('-evalModeList', default=['dialog'], nargs='+',
    ...
    if prePath == os.path.join(parsed['dataRoot'], ''):
        if not os.path.exists(prePath):
            prePath = '/hhd/lvxinyu/aqm_plus/resources/'

    # cocoInfo
    if not parsed['cocoInfo'] and 'train' not in parser.prog:
        parsed['cocoDir'] = '.'
        parsed['cocoInfo'] = '/home/lvxinyu/code/visdial-pytorch/val.json'
