...
from visdial.models.decoders import top_down2
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.AttModel = top_down2.AttModel()
    def forward(self, encStates, inputSeq):
        ...
        if inputSeq is not None:
            quesState, image1_K, imageMean = encStates
    ...
    def evalOptions(self, encStates, options, optionLens, scoringFunction):
        ...
        encStates = [quesState,image1_K,imageMean]
