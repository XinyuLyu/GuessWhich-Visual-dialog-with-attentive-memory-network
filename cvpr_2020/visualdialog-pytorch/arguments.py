...
def get_args():
  ...
  parser.add_argument('--outf', default='/hhd/lvxinyu/visualdialog-pytorch/checkoutpoints/', help='folder to output images and model checkpoints')
  ...
  parser.add_argument('--scratch', action='store_false', default=True, help='Train from Scratch')
