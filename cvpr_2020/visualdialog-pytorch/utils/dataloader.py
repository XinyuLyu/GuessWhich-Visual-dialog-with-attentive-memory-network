...
class train(data.Dataset): # torch wrapper
    def __init__(self, input_img_h5, input_ques_h5, input_json, v09_img, v09_param, negative_sample, num_val, data_split):
        ...
        f = json.load(open('/hhd/lvxinyu/visualdialog-pytorch/'+input_json, 'r')) # has img_train, img_val and itow
        ...
        # load the data.
        f = h5py.File('/hhd/lvxinyu/visualdialog-pytorch/'+input_img_h5, 'r')
        f2 = h5py.File('/hhd/lvxinyu/visualdialog-pytorch/'+v09_img,'r')['images_'+split]
        f2ids = json.load(open('/hhd/lvxinyu/visualdialog-pytorch/'+v09_param,'r'))['unique_img_'+split]
        ...
        f = h5py.File('/hhd/lvxinyu/visualdialog-pytorch/'+input_ques_h5, 'r')
